    ...
    <div v-transfer-dom>
      <x-dialog v-model="showTuijianDialog" class="dialog-demo">
        ...
        <div class="img-box">
          ...
          <p style="font-size:14px;margin-bottom:20px;color:#888;">长按关注</p>
        </div>
      </x-dialog>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      join(){
        ...
        //   + "&fansId=" + this.fansId;
        this.$router.push({name:'addResume',query:{id:this.positionId,fansId:this.fansId,companyId:this.companyId}})
      },
      join1(){
        this.$router.push({
          name: 'apply',
